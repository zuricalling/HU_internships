...
<head>
    ...
    <style>
        ...
        .flowchart-hero {
            ...
            padding: 80px 0; /* <--- กลับมาใช้ 80px ธรรมดา */
            color: white;
            text-align: center;
        ...
        /* ป้ายสถานะสีสันต่างๆ */
        .status-label { font-size: 12px; padding: 4px 12px; border-radius: 20px; font-weight: bold; color: white; display: inline-block; margin-right: 10px; }
        .bg-color-red { background-color: #dc3545; }
        .bg-color-yellow { background-color: #ffc107; color: #000; }
        .bg-color-blue { background-color: #0d6efd; }
        .bg-color-purple { background-color: #6f42c1; }
        .bg-color-green { background-color: #198754; }

        /* ---------------- กล่องแถบสถานะด้านขวา (Sticky) ---------------- */
        .status-box-header { background-color: #212529; color: white; padding: 15px; font-weight: bold; border-radius: 8px 8px 0 0; font-size: 14px;}
        .status-list li { border-bottom: 1px solid #eee; padding: 12px 15px; display: flex; align-items: center; font-size: 14px; font-weight: bold;}
        .status-list li:last-child { border-bottom: none; }
        .dot { width: 12px; height: 12px; border-radius: 50%; display: inline-block; margin-right: 15px; }

        .btn-red-login { background-color: #c4122d; color: white; font-weight: bold; }
        .btn-red-login:hover { background-color: #a00b22; color: white; }
    </style>
</head>
<body class="bg-light">
                ...
                <div class="timeline-section">
                    ...
                    <div class="timeline-step">
                        ...
                        <div class="timeline-card border-start border-danger border-4">
                            ...
                            <p class="text-muted small mb-3">นิสิตเข้าสู่ระบบและคีย์ข้อมูลสถานประกอบการ, วันที่เริ่มต้น-สิ้นสุด ผ่านระบบ Web Form เพื่อให้ข้อมูลเข้าสู่ฐานข้อมูล</p>
                    ...
                    <div class="timeline-step">
                        ...
                        <div class="timeline-card border-start border-warning border-4">
                            <h5 class="fw-bold text-warning" style="text-shadow: 1px 1px 1px rgba(0,0,0,0.1);"><i class="fas fa-inbox"></i> รับเรื่องเข้าระบบ</h5>
                            <p class="text-muted small mb-3">เจ้าหน้าที่คณะตรวจสอบความถูกต้องของข้อมูลเบื้องต้น และอัปเดตสถานะการรับเรื่อง</p>
                            <div>
                                <span class="status-label bg-color-yellow">สถานะ 1: รับเรื่องเข้าระบบ</span>
                                <span class="doer-badge"><i class="fas fa-file-signature"></i> ผู้ดำเนินการ: เจ้าหน้าที่</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-step">
                        ...
                        <div class="timeline-card border-start border-primary border-4">
                            <h5 class="fw-bold text-primary"><i class="fas fa-user-check"></i> อาจารย์ที่ปรึกษาพิจารณา</h5>
                            <p class="text-muted small mb-3">อาจารย์ประจำหลักสูตร Login เข้าสู่ระบบเพื่อตรวจสอบรายละเอียดคำขอฝึกงาน หากเหมาะสมจะทำการกดอนุมัติ</p>
                            <div>
                                <span class="status-label bg-color-blue">สถานะ 2: อาจารย์ที่ปรึกษาอนุมัติ</span>
                                <span class="doer-badge"><i class="fas fa-chalkboard-teacher"></i> ผู้ดำเนินการ: อาจารย์</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-step">
                        ...
                        <div class="timeline-card border-start border-4" style="border-color: #6f42c1 !important;">
                            <h5 class="fw-bold" style="color: #6f42c1;"><i class="fas fa-file-export"></i> ออกใบส่งตัว</h5>
                            <p class="text-muted small mb-3">เจ้าหน้าที่คณะจัดพิมพ์เอกสารหนังสือส่งตัวแบบเป็นทางการ เพื่อให้นิสิตนำไปยื่นให้กับสถานประกอบการ</p>
                            <div>
                    ...
                    <div class="timeline-step">
                        ...
                        <div class="timeline-card border-start border-success border-4">
                            ...
                            <p class="text-muted small mb-3">นิสิตปฏิบัติงานเสร็จสิ้น อาจารย์ประเมินผลการนิเทศน์สหกิจศึกษาและบันทึกผลลงระบบ</p>
                            <div>
                                <span class="status-label bg-color-green">สถานะ 4: ฝึกงานเสร็จสิ้น</span>
                                <span class="doer-badge"><i class="fas fa-users"></i> ผู้ดำเนินการ: อาจารย์ / เจ้าหน้าที่</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0 sticky-top" style="top: 100px;">
                    ...
                    <div class="card-body bg-light rounded-bottom text-center">
                        <p class="small text-muted mb-3 text-start">หากนิสิตพร้อมแล้ว สามารถเข้าสู่ระบบเพื่อยื่นคำร้องขอฝึกงานได้ทันที</p>
